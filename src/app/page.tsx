...
const THEMES = [
  "default", "dark", "radical", "tokyonight", "dracula", "nord",
  "gruvbox", "monokai", "cobalt", "synthwave", "midnight", "ocean",
  "sunset", "forest", "rose", "highcontrast", "catppuccin", "ember",
  "arctic", "transparent",
];
...
export default function Home() {
  ...
  const statsMd = `![GitHub Stats](${statsUrl})`;
  const langsMd = `![Top Languages](${langsUrl})`;
  const pinMd = `![Repo Card](${pinExample})`;
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="border-b border-[#21262d] px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6 text-sm text-[#8b949e]">
            <a href="#how-to-use" className="hover:text-white transition-colors">How It Works</a>
      ...
      <main className="flex-1">
        ...
        <section className="py-16 sm:py-24 px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-[#8b949e] mb-10 max-w-lg mx-auto">
              Enter your GitHub username, pick a theme, and get ready-to-use markdown
              for your profile README. Free and open source.
            </p>
          ...
          <section ref={resultsRef} id="results" className="pb-16 px-6">
            <div className="max-w-4xl mx-auto space-y-6">
              <h3 className="text-2xl font-bold text-white text-center mb-8">
                Your Cards for <span className="text-blue-400">@{username}</span>
              </h3>
              ...
              <div className="bg-[#161b22] rounded-xl p-5 border border-[#21262d]">
                <div className="flex flex-wrap items-end gap-4">
                  <div className="flex-1 min-w-[140px]">
                    <label className="block text-xs font-medium text-[#8b949e] mb-1">Theme</label>
                    <select
                      value={theme}
                      onChange={(e) => { setTheme(e.target.value); setGenKey((k) => k + 1); }}
                  ...
                  <div className="flex-1 min-w-[140px]">
                    <label className="block text-xs font-medium text-[#8b949e] mb-1">Languages Layout</label>
                    <select
                      value={langsLayout}
                      onChange={(e) => { setLangsLayout(e.target.value); setGenKey((k) => k + 1); }}
                      className="w-full px-3 py-2 bg-[#0d1117] border border-[#30363d] rounded-lg text-white text-sm focus:outline-none focus:border-blue-500"
                    >
                  ...
                  <label className="flex items-center gap-2 text-sm text-[#8b949e] cursor-pointer pb-0.5">
                    <input type="checkbox" checked={showIcons} onChange={(e) => { setShowIcons(e.target.checked); setGenKey((k) => k + 1); }} className="accent-blue-500" />
                    Icons
                  </label>
                  <label className="flex items-center gap-2 text-sm text-[#8b949e] cursor-pointer pb-0.5">
                    <input type="checkbox" checked={hideBorder} onChange={(e) => { setHideBorder(e.target.checked); setGenKey((k) => k + 1); }} className="accent-blue-500" />
                    Borderless
                  </label>
                </div>
              </div>
              ...
              <div className="bg-[#161b22] rounded-xl border border-[#21262d] overflow-hidden">
                <div className="px-6 py-4 border-b border-[#21262d] flex items-center justify-between">
                  ...
                  <button
                    onClick={() => copyToClipboard(pinMd, "pin")}
                ...
                <div className="px-6 py-4">
                  <p className="text-sm text-[#8b949e] mb-3">
                    To pin a specific repo, replace <code className="text-blue-400 bg-blue-500/10 px-1.5 py-0.5 rounded text-xs">REPO_NAME</code> with your repository name:
                  </p>
              ...
              <div className="text-center pt-2">
                <button
                  onClick={() => copyToClipboard(`${statsMd}\n\n${langsMd}`, "all")}
                ...
                >
                  {copied === "all" ? "Copied Both Cards!" : "Copy Stats + Languages Markdown"}
                </button>
              </div>
            </div>
          </section>
        ...
        <section id="how-to-use" className="py-16 px-6 border-t border-[#21262d]">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <StepBox step={1} title="Enter Username" desc="Type your GitHub username in the input above." />
              <StepBox step={2} title="Pick a Theme" desc="Choose from 20 built-in themes to match your style." />
              <StepBox step={3} title="Copy Markdown" desc="Click the copy button on any card you want." />
              <StepBox step={4} title="Paste in README" desc="Add the markdown to your GitHub profile README.md file." />
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-6 border-t border-[#21262d]">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            <FeatureBox title="Stats Card" desc="Stars, commits, PRs, issues, and rank all in one beautiful card." icon="chart" />
            <FeatureBox title="Top Languages" desc="Display your most used programming languages with multiple layouts." icon="code" />
            <FeatureBox title="Repo Pins" desc="Pin and showcase individual repositories on your profile." icon="pin" />
          </div>
        </section>
        ...
        <section id="themes" className="py-16 px-6 border-t border-[#21262d]">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {mounted && THEMES.filter((t) => t !== "transparent").map((t) => (
                <button
                  key={t}
                  onClick={() => {
                    setTheme(t);
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-12">
              <DocSection title="Stats Card" endpoint="/api/stats">
                ...
                <DocParam name="theme" desc="Card theme (default, dark, radical, tokyonight, ...)" />
                <DocParam name="show_icons" desc="Show icons beside stats (true/false)" />
                <DocParam name="hide_border" desc="Hide card border (true/false)" />
                <DocParam name="hide_rank" desc="Hide rank circle (true/false)" />
                <DocParam name="hide" desc="Comma-separated stats to hide (stars,commits,prs,issues,contribs)" />
                <DocParam name="custom_title" desc="Custom card title" />
                <DocParam name="title_color" desc="Title color hex (without #)" />
                <DocParam name="text_color" desc="Text color hex" />
                <DocParam name="icon_color" desc="Icon color hex" />
                <DocParam name="bg_color" desc="Background color hex or gradient (angle,color1,color2)" />
                <DocParam name="border_color" desc="Border color hex" />
                <DocParam name="ring_color" desc="Rank ring color hex" />
                <DocParam name="cache_seconds" desc="Cache duration in seconds (min 1800)" />
                <DocParam name="disable_animations" desc="Disable animations (true/false)" />
              </DocSection>

              <DocSection title="Top Languages" endpoint="/api/top-langs">
                <DocParam name="username" required desc="GitHub username" />
                <DocParam name="theme" desc="Card theme" />
                <DocParam name="layout" desc="Layout: normal, compact, donut, pie" />
                <DocParam name="langs_count" desc="Number of languages to show (default: 5)" />
                <DocParam name="hide" desc="Comma-separated languages to hide" />
                <DocParam name="exclude_repo" desc="Comma-separated repos to exclude" />
                <DocParam name="hide_border" desc="Hide card border" />
                <DocParam name="cache_seconds" desc="Cache duration in seconds" />
              </DocSection>
              ...
              <DocSection title="Repo Pin" endpoint="/api/pin">
                ...
                <DocParam name="theme" desc="Card theme" />
                <DocParam name="show_owner" desc="Show owner name (true/false)" />
                <DocParam name="hide_border" desc="Hide card border" />
                <DocParam name="description_lines" desc="Number of description lines (default: 2)" />
                <DocParam name="cache_seconds" desc="Cache duration in seconds" />
              </DocSection>
      ...
      {/* Footer */}
      <footer className={`border-t border-[#21262d] py-6 px-6 ${generated ? "pb-20" : ""}`}>
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-[#8b949e]">
          ...
          <p>
            Built by{" "}
            <a href="https://github.com/recepgocmen" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">
              @recepgocmen
            </a>
          </p>
        </div>
              ...
              <div className="max-w-4xl mx-auto space-y-3">
                <div className="flex items-center justify-between mb-2">
                  <h4 className="text-sm font-semibold text-white">
                    Quick Copy for <span className="text-blue-400">@{username}</span>
                  </h4>
                  <button onClick={() => setStickyOpen(false)} className="text-[#8b949e] hover:text-white text-lg leading-none">&times;</button>
                </div>
                <SnippetRow label="Stats" markdown={statsMd} id="qs-stats" copied={copied} onCopy={copyToClipboard} />
                <SnippetRow label="Languages" markdown={langsMd} id="qs-langs" copied={copied} onCopy={copyToClipboard} />
                <SnippetRow label="Repo Pin" markdown={pinMd} id="qs-pin" copied={copied} onCopy={copyToClipboard} />
                <div className="pt-1">
                  <button
                    onClick={() => copyToClipboard(`${statsMd}\n\n${langsMd}`, "qs-all")}
                    className={`w-full py-2.5 text-sm font-medium rounded-lg transition-colors ${
                      copied === "qs-all" ? "bg-green-600 text-white" : "bg-blue-600 hover:bg-blue-700 text-white"
                    }`}
                  >
                    {copied === "qs-all" ? "Copied!" : "Copy All (Stats + Languages)"}
                  </button>
                </div>
              </div>
            </div>
  ...
  return (
    <div className="bg-[#161b22] rounded-xl border border-[#21262d] overflow-hidden">
      <div className="px-6 py-4 border-b border-[#21262d] flex items-center justify-between">
        ...
        >
          {copied === id ? "Copied!" : "Copy Markdown"}
        </button>
      </div>
...
function StepBox({ step, title, desc }: { step: number; title: string; desc: string }) {
  return (
...
function DocSection({ title, endpoint, children }: { title: string; endpoint: string; children: React.ReactNode }) {
  return (
    <div className="bg-[#161b22] rounded-xl border border-[#21262d] overflow-hidden">
      <div className="px-6 py-4 border-b border-[#21262d] flex items-center gap-3">
        <h4 className="text-lg font-bold text-white">{title}</h4>
        <code className="text-sm text-blue-400 bg-blue-500/10 px-2 py-0.5 rounded">GET {endpoint}</code>
      </div>
      <div className="px-6 py-4">
...
function DocParam({ name, desc, required }: { name: string; desc: string; required?: boolean }) {
  return (
    <tr>
      <td className="py-2.5 pr-4">
        <code className="text-sm text-[#c9d1d9] font-mono">{name}</code>
        {required && <span className="ml-1.5 text-xs text-red-400 font-medium">required</span>}
      </td>
...
function SnippetRow({
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="text-xs font-medium text-[#8b949e] w-20 shrink-0">{label}</span>
      ...
      <button
        ...
        className={`shrink-0 px-3 py-1.5 text-xs font-medium rounded-lg transition-colors ${
          copied === id ? "bg-green-600 text-white" : "bg-[#21262d] text-[#8b949e] hover:bg-[#30363d]"
        }`}
      >
...
function QuickStartBlock({
  ...
  const lines = [
    { label: "Stats Card", id: "doc-stats", md: `![GitHub Stats](${PROD_DOMAIN}/api/stats?username=${u}&theme=${theme}${amp})` },
    { label: "Top Languages", id: "doc-langs", md: `![Top Languages](${PROD_DOMAIN}/api/top-langs?username=${u}&theme=${theme}&layout=${langsLayout}${amp})` },
    { label: "Repo Pin", id: "doc-pin", md: `![Repo Card](${PROD_DOMAIN}/api/pin?username=${u}&theme=${theme}&repo=REPO_NAME${amp})` },
  ];
  ...
  return (
    <div className="bg-[#161b22] rounded-xl p-6 border border-[#21262d]">
      ...
      <p className="text-sm text-[#8b949e] mb-4">
        Add these to your GitHub profile README.md{u !== "YOUR_USERNAME" && <> (ready for <span className="text-blue-400 font-medium">@{u}</span>)</>}:
      </p>
          ...
          <div key={line.id} className="flex items-start gap-3">
            ...
            <button
              ...
              className={`shrink-0 mt-1 p-2 rounded-lg transition-colors ${
                copied === line.id ? "bg-green-600 text-white" : "bg-[#21262d] text-[#8b949e] hover:bg-[#30363d] hover:text-white"
              }`}
            >
              {copied === line.id ? (
